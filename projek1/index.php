    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><b>Menghitung Body Mass Index(BMI)/Index Masa Tubuh(IMT)</b></h4>
                ...
                <div class="card card-info">
                    ...
                    <form method="post" action="index.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <h4><b>Data Untuk Menghitung BMI</b></h4>
                            <div class="form-group row">
            ...
            $pasien_hardcode = [ 'tanggal' => '16-04-2022', 'nama' => 'Abdul', 'jk' => 'Laki-laki', 'bb' => 55.7, 'tb' => 181, 'bmi' => 16.8, 'status' => 'Kurus', 'image' => 'kurus'];
            $pasien_hardcode = [ 'tanggal' => '16-04-2022', 'nama' => 'Abdul', 'jk' => 'Laki-laki', 'bb' => 55.7, 'tb' => 181, 'bmi' => 16.8, 'status' => 'Kurus', 'image' => 'kurus'];
            // Informasi Pribadi
            ...
            ?>
                <div class="card-body" id="hasil">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Hasil Data (IMT)/(BMI)</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
